const ParametersViewResistivity = ({ mode, parametr1 ='', parametr2, parametr3, parametr4, parametr5, parametr6, parametr7, parametr8, parametr9, parametr10
   }) => {
  return (
    <div className="border-solid border-2 border-black rounded-3xl flex flex-col">
      ...
      <div className="m-2 text-sm">
        <p>Oporność: {parametr1} {parametr2}</p>
...
export default ParametersViewResistivity;
